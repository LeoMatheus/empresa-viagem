 ...
 * É usada para tratar o problema de Same-Origin-Policy, ou seja, quando o browser impede 
 * que um arquivo JS
...
app.use(function (req, res, next) {
  ...
  // Encaminha a requisição para a próxima camada do middleware, ou seja, para o método 
  //que irá tratar de fato requisição
  next();
});
